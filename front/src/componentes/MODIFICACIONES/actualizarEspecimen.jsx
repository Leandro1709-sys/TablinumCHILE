...
import { gradoAdecimal, Toast, decimalAGrado, fechaActual, getPartes, getCuencaFormacion, getDatos, getFilo, selectCuenca, getGeneroEspecie, getPeriodoEpoca, postDatos, postCuencaFormacion, postFilo, postGeneroEspecie, selectEpoca, selectEspecie, postBochon, putBochon, getBochones, postEspecimen, postParte, subespecimen } from "../../store/action";
import { url } from '../../URL.js'
import {ordenar} from '../../FUNCIONES/functions'
...
export default function ActualizarEspecimen() {
    ...
    const partes1 = useSelector((state) => state.partes)
    const partes = ordenar(partes1)
    ...
    function modificarEspe(e) { // funcion para actualizar datos del estado(con las modificaciones)
        ...
        if(e.target.name=='comentario'&&e.target.value==''){
    ...
    function handleSelectionPartes(e) {
        ...
        if (!especimen.partesesqueletales.includes(e.target.value)) {
            ...
            Toast.fire({ icon: 'error', title:t("-PARTE") })
            ...
            <div className="contenido34">
                ...
                <div className="cabecera">
                    ...
                    <div className="vuelve">
                        <Link to={'/home/' + especimen?.especimennumero} className="limpiar">{t("VOLVER")}</Link>
                    </div>

                    <div className="a">
                    {t("MODIFESP")} {especimen ? subespecimen(especimen?.especimennumero) : ''}
                    </div>
                    {
             ...
             : null
                ...
                <div className="cuerpo">
                    ...
                    <div className="col1">
                        <div className="info1">
                            <div className="texto">
                                <label className="label"> <span title={t("TABLA")} flow='down'>
                                    <a className="labelH" href={crono} target='_blank'>{t("PERIODO")} :</a></span></label>
                            </div>
                            <div className="content">
                        ...
                        <div class='info1'>
                            ...
                            <div className="content">
                                <input type='text' name='miembro' className="in" list='miembro' onChange={(e) => { modificarEspe(e) }} placeholder={modificacion?.espPrev.miembro} />
                            </div>
                        </div>
                        <div class='info1'>
                            <div className="texto">
                            ...
                            <div className="content">
                                <input type='text' className="in" name='localidad' list='localidad' onChange={(e) => { modificarEspe(e) }} placeholder={modificacion?.espPrev.localidad} />
                            </div>
                        </div>
                        <div class='info1'>
                            <div className="texto">
                            ...
                            <div className="content">
                                <input type='text' className="in" name='campana' list='campana' onChange={(e) => { modificarEspe(e) }} placeholder={modificacion?.espPrev.campana} />
                            </div>
                        </div>
                        <div class='info1'>
                            <div className="texto">
                    ...
                    <div className="col1">
                        ...
                        <div class='info141'>
                            ...
                            <div className="coorde">
                                <div className="coordeIn">
                                    ...
                                    <input className="coor" min='0' id='input2' type='number' name='minutos' placeholder={coordenadas?.latitud.min} onChange={(e) => { handleLat(e) }} ></input> <p className="p">{"'"} </p>
                                    <input className="coorseg" min='0' id='input3' type='number' name='segundos' placeholder={coordenadas?.latitud.seg} onChange={(e) => { handleLat(e) }} ></input> <p className="p">{'" '}</p>
                                </div>
                            </div>
                            <div className="coorde">
                                <div className="coordeIn">
                        ...
                        <div class='info1coment'>
                            ...
                            <div className="content">
                                <textarea type='text' class='textar' name='comentario' onInput={(e) => { modificarEspe(e) }} defaultValue={modificacion?.espPrev.comentario} />
                            </div>
                        </div>
                        <div class='info1'>
                            <div className="texto">
                            ...
                            <div className="mostrador3">
                                ...
                                </div>
                                {
                                    especimen?.imagen?.length > 0 ? especimen?.imagen.map(el => {
                                        return <div>
                                             <span tooltip={t("CLICK")}  className="butono"></span>
                                                        {                                                          
                                                            el.length < 40 ? 
